class Swift < Formula
  ...
  def install
    ...
    mkdir build do
      ...
      on_linux do
        ...
        post_args += %W[
          ...
          --install-libdispatch
          --install-xctest
          --swift-cmake-options=-DCMAKE_INSTALL_RPATH=$ORIGIN/../lib
    ...
    on_macos do
      ...
      # This allows relocatable bottles.
      ...
      %w[
        ...
        MachO::Tools.delete_rpath("#{prefix}#{install_prefix}/#{path}",
                                  "#{prefix}#{install_prefix}/lib/swift/macosx")
      end
    end
  ...
  test do
    ...
    mkdir "swiftpmtest" do
      ...
      assert_match "swift.org\n", shell_output("#{prefix}#{toolchain_prefix}/bin/swift run -v --disable-sandbox")
    end
  end
end
